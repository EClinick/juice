...
///
/// Mirrors ``ChargeTimelineView`` but sizes up for a full window and accepts an
/// `hours` parameter used to label the covered range. A little duplication keeps
/// the popover's compact chart independent of this one.
