...
for command in awk cmp codesign curl ditto gh git grep hdiutil lipo make osascript otool perl plutil rg ruby security sed shasum spctl strings swift tail xcrun xmllint; do
